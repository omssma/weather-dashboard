...
var getUserWeather = async function (city) {
    ...
    var displayWeather = async function (data) {
      ...
      var forecast = await fetch(
        "https://api.openweathermap.org/data/2.5/onecall?lat=" +
          ...
          "&lon=" +
          coordLon +
          "&units=imperial&exclude=current, minutely,hourly, alerts&appid=df40b5608b8598db044ae503ae0da845"
      );
  ...
  var apiUrl =
    ...
    city +
    "&units=imperial&appid=0709fe582a3226805c5caaebd2b415a5";
...
var displayCurrentWeather = function (weather, uvi) {
  ...
  todaysWeatherInfoEl.textContent =
    "Temp: " +
    tempInfo +
    " " +
    "Wind: " +
...
var displayForecast = function (forecastArr) {
  ...
  for (var i = 1; i < 6; i++) {
    ...
    forecastInfoEl.textContent =
      forecastTemp + " " + forecastWind + " " + forecastHum;
